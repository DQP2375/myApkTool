...
public class CmdExecutor {
    ...
    public static boolean executorRoot(String executeStr) throws IOException, InterruptedException {
        return executorRoot(executeStr, "GB2312");
    }
    ...
    public static boolean executorRoot(String executeStr, String character) throws IOException, InterruptedException {
        System.out.println("执行命令：" + executeStr);
        Runtime runtime = Runtime.getRuntime();
        Process p = runtime.exec("su");
        runtime.exec(executeStr);
        StreamGobbler errorGobbler = new StreamGobbler(p.getErrorStream(), character);
        errorGobbler.start();
